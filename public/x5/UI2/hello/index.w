...
<html style="width:100%;height:100%" class="no-js">
  ...
  <div component="$model/UI2/system/components/justep/panel/panel" class="x-panel x-full pf632472171b24bba85401bffe695c63a-iosstatusbar" data-bind="component:{name:'$model/UI2/system/components/justep/panel/panel'}"> 
    <div class="x-panel-top" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}"> 
      <div component="$model/UI2/system/components/justep/titleBar/titleBar" class="x-titlebar" data-bind="component:{name:'$model/UI2/system/components/justep/titleBar/titleBar'}" data-config="{&#34;title&#34;:&#34;创建好友圈&#34;}"> 
        ...
        <div class="x-titlebar-title">创建好友圈</div>  
    ...
    <div class="x-panel-content" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}">
      <div component="$model/UI2/system/components/justep/row/row" class="x-row" xid="row1" style="margin-top:50px;" data-bind="component:{name:'$model/UI2/system/components/justep/row/row'}"> 
        <div class="x-col  x-col-center" xid="col1">
          <input component="$model/UI2/system/components/justep/input/input" class="form-control" xid="Keyword" style="text-align:left;" data-bind="component:{name:'$model/UI2/system/components/justep/input/input'}" data-config="{&#34;placeHolder&#34;:&#34;输入关键字&#34;}">
        </div> 
      </div>  
      <div component="$model/UI2/system/components/justep/row/row" class="x-row" xid="row2" style="margin-top:10px;" data-bind="component:{name:'$model/UI2/system/components/justep/row/row'}"> 
        <div class="x-col" xid="col3">
          <a component="$model/UI2/system/components/justep/button/button" class="btn btn-default" xid="SearchBt" style="width:100%;" data-bind="component:{name:'$model/UI2/system/components/justep/button/button'}" data-events="onClick:SearchBt" data-config="{&#34;label&#34;:&#34;创  建&#34;}"> 
            <i xid="i1"></i>  
            <span xid="button1">创 建</span>
          </a>
        </div> 
      </div>
    </div>  
    <style>.x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-top {height: 48px;}.x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-content { top: 48px;bottom: nullpx;}.x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-bottom {height: nullpx;}.iosstatusbar .x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-top {height: 68px;}.iosstatusbar .x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-content { top: 68px;}.iosstatusbar .x-panel .x-panel-content .x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-top {height: 48px;}.iosstatusbar .x-panel .x-panel-content .x-panel.pf632472171b24bba85401bffe695c63a-iosstatusbar >.x-panel-content {top: 48px;}</style>
  </div> 
</div></div>
        ...
        <script src="../../UI2/system/core.min.js"></script><script src="../../UI2/system/common.min.js"></script><script src="../../UI2/system/components/comp.min.js"></script><script id="_mainScript">
			...
			if (__continueRun) {
    			...
    			require(['require', 'jquery', '$model/UI2/system/lib/base/composition', '$model/UI2/system/components/justep/loadingBar/loadingBar','$model/UI2/system/lib/cordova/cordova','$model/UI2/activity2WindowURL'],  function (require, $, composition) { 
    				...
    				var context = {};
    				context.model = '$model/UI2/hello/index.w' + (document.location.search || "");
